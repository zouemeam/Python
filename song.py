...
class Album():
    ...
    def add_song(self, title, position=None):
        """Adds a song to the track(list)
        Args:
            title(str): a song to add
        ...
        if song_found is None:
            song_found=Song(title, self.artist)
            if position is None:
...
class Artist():
    ...
    def add_song(self,name,year,title):
        """Adds a new song to the artist object
        ...
        Args:
            ...
            title(str): The name of the song to add
            """
        album_found=find_object(name,self.albums)
        if album_found is None:
            print(name+"not found")
            new_album=Album(name,year,self.name)
